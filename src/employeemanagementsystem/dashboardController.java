...
public class dashboardController implements Initializable {
    ...
    public void addEmployeeInsertImage() {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURI().toString(), 141, 140, false, true);
            addEmployee_image.setImage(image);
        }

    }
    
    public String [] positionList = {"Marketer coordinator", "Web Developer (Back End)", "Web Developer (Front End)", "App Developer"};
    ...
    public void addEmployeeSelect() {
        ...
        image = new Image(uri, 141, 140, false, true);
        addEmployee_image.setImage(image);
    }
    ...
    public void defaultNav(){
        home_btn.setStyle("-fx-background-color: linear-gradient(to bottom right, #517fa4, #243949);");
    }
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == home_btn) {
            ...
            addEmployee_btn.setStyle("-fx-background-color: linear-gradient(to bottom right, #517fa4, #243949);");
            ...
            salary_btn.setStyle("-fx-background-color: linear-gradient(to bottom right, #517fa4, #243949);");
            addEmployee_btn.setStyle("-fx-background-color: transparent");
            home_btn.setStyle("-fx-background-color: transparent");
